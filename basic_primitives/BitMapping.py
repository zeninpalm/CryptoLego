...
class BitMapping:
    ...
    def remove(self, from_bitstring):
        """
        Require:    from_bitstring != None
                    self.contains(from_bitstring)
        Ensure:     !self.contains(from_bitstring)
        """
        del self._mapping_pairs[from_bitstring]

    def map(self, from_bitstring):
        """
